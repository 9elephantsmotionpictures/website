...
function ContactUs() {
  ...
  return (
    <main className="overflow-hidden bg-white">
      ...
      <section
        className="
        relative flex min-h-[75vh] items-center overflow-hidden
        bg-[#081C31]
        bg-[radial-gradient(circle_at_20%_20%,rgba(37, 100, 235, 0.33),transparent_35%),radial-gradient(circle_at_80%_70%,rgba(113, 44, 232, 0.27),transparent_35%),linear-gradient(135deg,#071028,#0f172a,#111827)]
      "
      >
        <div className="pointer-events-none absolute -left-32 -bottom-40 h-96 w-96 rounded-full bg-blue-500/20 blur-[100px]" />

        <div className="pointer-events-none absolute -top-30 -right-32 h-96 w-96 rounded-full bg-blue-400/20 blur-[100px]" />
